...
const SignIn = () => {
  return (
    <SafeAreaView className='flex-1 justify-center items-center bg-primary-50 px-4'>
      ...
      <CustomButton title='Connect with Internet Identity' bgVariant='primary' onPress={() => router.replace('/(auth)/plug-wallet')} className="w-11/12" IconLeft={() => <Ionicons name='infinite-outline' size={24} color='black' className='mr-2' />} />
    </SafeAreaView>
  )
}
