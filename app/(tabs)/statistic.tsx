...
export default function Statistics() {
  ...
  return (
    <Layout>
      {/* Konten scrollable */}
      <ScrollView contentContainerStyle={{ paddingTop: 40, paddingHorizontal: 16 }} scrollEventThrottle={16} decelerationRate="normal">
        {/* Map Card */}
        ...
        <View className="mb-6 border p-4 rounded-xl overflow-hidden" style={{ backgroundColor: '#F3F4F6' }}>
          <View className="flex-row justify-between items-center mb-4">
            ...
            <View className="flex-row items-center">
              ...
              <TouchableOpacity className={`px-4 py-2 rounded-lg ${showDetail ? 'bg-red-500' : 'bg-blue-500'}`} onPress={toggleDetail}>
          ...
          <View className="mb-4">
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 4 }}>
              {availableYears.map(year => (
                <TouchableOpacity key={year} className={`px-4 py-2 rounded-full mr-2 ${selectedYear === year ? 'bg-green-500' : 'bg-gray-200'}`} onPress={() => handleYearChange(year as Year)}>
              ...
              <View className="mb-4">
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 4 }}>
                  ...
                  {getCurrentYearData().map((item, index) => (
                    <TouchableOpacity key={index} className={`px-4 py-2 rounded-full mr-2 ${selectedDay === item.label ? 'bg-red-500' : 'bg-gray-200'}`} onPress={() => handleDayChange(item.label as Day)}>
