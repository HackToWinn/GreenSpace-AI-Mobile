...
const NotFoundScreen = () => {
  ...
  return (
    <View className="flex-1 px-12 justify-center items-center bg-white">
      ...
      <CustomButton onPress={() => router.replace('/(tabs)/home')} title="Go home" bgVariant="primary" textVariant="secondary" className="mt-4 w-24" IconLeft={() => <Ionicons name='home-outline' size={24} color='white' className='mr-2' />} />
    </View>
  );
};
