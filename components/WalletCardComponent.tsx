    ...
    <>
      <View className="w-full bg-white p-6 rounded-xl shadow-md shadow-neutral-400 mb-6">
        <View className="flex-row justify-between items-center mb-6">
          ...
          <Text className="text-xs font-Regular text-gray-500 bg-gray-200 px-2 py-1 rounded-full">Wallet Status: {savedWalletAddress ? 'Connected' : 'Offline'}</Text>
        </View>
        ...
        <SafeAreaView className="flex-1 h-full justify-center items-center bg-primary-50/50 backdrop-blur-sm">
          <View className="bg-white m-4 rounded-xl p-6 shadow-lg w-11/12 max-w-md">
            ...
            <View className="mb-6">
              ...
              <TextInput
                className="border border-gray-300 rounded-lg px-3 py-3 text-base font-Regular"
                placeholder="abcde-fghij-klmno-pqrst-uvw"
                value={walletAddress}
                ...
                style={{ minHeight: 80 }}
              />
              {walletAddress && !validatePrincipalID(walletAddress) && (
